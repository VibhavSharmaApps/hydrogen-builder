  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute bottom-12 left-8 md:left-16 flex flex-col gap-4">
        <p className="text-xs tracking-widest uppercase text-neutral-300">{subheading}</p>
        <h1 className="text-5xl md:text-7xl font-thin text-white max-w-lg leading-none">{heading}</h1>
        <a
          href={ctaLink}
          className="self-start border border-white px-8 py-3 text-xs tracking-widest uppercase text-white hover:bg-white hover:text-neutral-950 transition-colors duration-300"
        >
          {ctaText}
        </a>
      </div>
...
function SplitLayout({ heading, subheading, ctaText, ctaLink, backgroundImage, overlayOpacity }: Omit<HeroSectionProps, 'variant'>) {
  return (
    <section className="flex flex-col md:flex-row w-full min-h-screen">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-16 py-16 gap-6 bg-neutral-100">
        <p className="text-xs tracking-widest uppercase text-zinc-400">{subheading}</p>
        <h1 className="text-4xl md:text-6xl font-thin text-neutral-950 leading-none">{heading}</h1>
        <a
          href={ctaLink}
          className="self-start border border-neutral-950 px-8 py-3 text-xs tracking-widest uppercase text-neutral-950 hover:bg-neutral-950 hover:text-white transition-colors duration-300"
        >
          {ctaText}
        </a>
      </div>
